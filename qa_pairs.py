...
Each pair includes a question and reference (ground-truth) answer.
"""
...
QA_PAIRS = [
    ...
    },
    {
        ...
        "reference": "A method to train LLMs with explicit values and principles using AI feedback instead of human feedback."
    },
    {
        "question": "What are the benefits of prompt engineering?",
        "reference": "Prompt engineering improves LLM output quality without changing model weights, enabling rapid iteration."
    },
    {
        "question": "What is few-shot prompting?",
        "reference": "Few-shot prompting provides a few examples in the prompt to guide the LLM on the desired output format and style."
    },
    {
        "question": "What are the differences between zero-shot and few-shot prompting?",
        "reference": "Zero-shot gives no examples; few-shot provides examples. Few-shot typically produces better results."
    },
]
